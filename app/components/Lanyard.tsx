...
// Reusing lanyard.png as a valid fallback texture so useTexture doesn't fail.
// The compositing logic ignores it if frontImage/backImage are null anyway.
const BLANK_PIXEL = lanyardPNG;
...
function Band({
  ...
  const texture = useTexture(lanyardImage || lanyardPNG) as any;
